...
const footerLinks = {
  Services: [
    { label: "Web Development", href: "/services#technical" },
    { label: "DevOps & Cloud", href: "/services#technical" },
    { label: "Brand Identity", href: "/services#creative" },
    { label: "UI/UX Design", href: "/services#creative" },
    { label: "Engagement Models", href: "/services#engagement" },
  ],
  Company: [
...
export default function Footer() {
  ...
  return (
    <footer className={`bg-black border-t border-av-border ${spacing.sectionX} pt-16 pb-10`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-white/50 text-sm leading-relaxed max-w-sm mb-6">
              ...
              creative precision — built for scale, designed to last.
            </p>
            <div className="flex items-center gap-4">
              ...
              {[
                ...
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="w-9 h-9 border border-av-border rounded-sm flex items-center justify-center text-white/50 hover:text-av-teal hover:border-av-teal transition-all duration-200"
                >
                  {icon}
                </a>
              ))}
              ...
              <ul className="space-y-3" role="list">
                {links.map(({ label, href }) => (
                  <li key={label}>
                    <Link
                      href={href}
                      className="text-white/50 hover:text-av-teal text-sm transition-colors duration-200"
                    >
                      {label}
                    </Link>
                  </li>
